    ...
    return (
        <div className="flex flex-col w-full gap-6 animate-fadeIn">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-1 justify-between p-4 rounded-xl border border-border bg-bg-secondary/30">
                    ...
                    <Button
                        ...
                        variant="outline"
                        className="bg-button hover:bg-button/95 text-bg cursor-pointer rounded-2xl px-5 h-9 gap-2 w-full sm:w-auto shrink-0"
                    >
                        <Image
                            src="/icons/ai.svg"
                            alt="Generate"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-1 justify-between p-4 rounded-xl border border-border bg-bg-secondary/30">
                    ...
                    <Button
                        ...
                        variant="outline"
                        className="bg-button hover:bg-button/95 text-bg rounded-2xl cursor-pointer px-5 h-9 gap-2 w-full sm:w-auto shrink-0"
                    >
                        <Image
                            src="/icons/ai.svg"
                            alt="Generate"
